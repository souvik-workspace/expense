                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body" style="min-height:200px;">
                                    <div class="container">
                                        <form action="{{url('admin/editGroupSubmit/'.$group->id)}}" method="POST">
                                            @csrf
                                          <div class="form-group">
                                            <label for="group_name">Group Name:</label>
                                            <input type="text" name="group_name" class="form-control" id="group_name" value="{{$group->group_name}}" placeholder="Enter Group Name">
                                            <span class="errorMsg">{{$errors->first('group_name')}}</span>
                                          </div>
                                          <div class="form-group">
                                            <label for="status">Status:</label>                                            
                                            <select name="status" class="form-control" id="status">
                                            <option value="1" <?php if($group->status ==1){ echo "Selected";} ?>>Active</option>
                                            <option value="0" <?php if($group->status ==0){ echo "Selected";} ?>>Inactive</option>
                                            </select>
